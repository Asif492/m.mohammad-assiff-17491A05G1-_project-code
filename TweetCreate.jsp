...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="text">
        <h1><a href="#" class="style1">Information Dissemination From Social Network for Extreme Weather Scenario</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2">Create Weather Tweets </h2>
          ...
          <form action="TweetCreateAuthen.jsp" method="post" id="" enctype="multipart/form-data">
            <ol>
			  ...
			  <li>
                <label for="description">Enter Weather Details </label>
                <input name="weather" type="text" id="wea" value="" />
              </li>
			  <li>
                <label for="description">Enter Location Details </label>
                <input name="loc" type="text" id="loc" value="" />
              </li>
