...
<%
					...
					try {
						...
						while (params.hasMoreElements()) 
						{
							...
							if(paramname.equalsIgnoreCase("weather"))
							{
								weather=multi.getParameter(paramname);
							}
					...
					if ( rs1.next() )
					   ...
					   else
					   {
						...
						PreparedStatement ps=connection.prepareStatement("insert into ttopic(tname,description,hash,imagess,dt,weather,loc,user,rank) values(?,?,?,?,?,?,?,?,?)");
