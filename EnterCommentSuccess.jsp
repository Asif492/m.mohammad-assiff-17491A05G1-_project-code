...
try{
	...
	String weather=(String)application.getAttribute("weather");
	...
	String comment=request.getParameter("textarea");
						...
						int i=0,rank=0,rank1=0;            
							...
							if(rs5.next()==true)
							{
									...
									PreparedStatement ps=connection.prepareStatement("insert into tcomment(tname,hash,comments,user,dt,weather,loc) values(?,?,?,?,?,?,?)");
									ps.setString(1,tname1);
									ps.setString(2,hash);
									ps.setString(3,comment);
									ps.setString(4,uname);	
									ps.setString(5,strDate2);
									ps.setString(6,weather);	
									ps.setString(7,loc);	
...
<%	
							...
							else
							{
									...
									String sql11="Update ttopic set rank="+rank1+" where tname='"+tname1+"' ";
